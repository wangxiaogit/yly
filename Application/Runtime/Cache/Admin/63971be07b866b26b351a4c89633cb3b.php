...
<body>
    <div class="wrap">
        <ul class="nav nav-tabs">
            <li><a href="<?php echo U('RequiredDocument/index');?>"><?php echo ($meta_title); ?></a></li>
            <li class="active"><a href="<?php echo U('RequiredDocument/add');?>">新增</a></li>
        </ul>
        <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('RequiredDocument/do_add');?>">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name='document_type'>
                            <?php if(is_array($documentType)): foreach($documentType as $k=>$vo): ?><option value='<?php echo ($k); ?>'><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                </div>
                <div class="control-group">
            ...
            <div class="form-actions">
                ...
                <a class="btn" href="<?php echo U('RequiredDocument/index');?>">返回</a>
            </div>
        </form>
    </div>
